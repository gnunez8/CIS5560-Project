...
#file_location = "/FileStore/tables/2017_County.csv"
file_location = "/user/jdang8/2017_County.csv"
file_type = "csv"
...
temp_table_name = "2017_County_csv"
...
# %sql
#select * from `2017_County_csv`

#df.take(10)

#df_sql = spark.sql("select * from 2017_County_csv LIMIT 10")
#display(df_sql)
...
print("Table 2017_County with Dropped Columns")
#df2.show()
