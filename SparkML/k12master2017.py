...
file_location = "/user/jdang8/2017_K12Education.csv"
file_type = "csv"
...
# %sql
#select * from `2017_K12Education_csv`

#df.take(10)

#df_sql = spark.sql("select * from 2017_K12Education_csv LIMIT 10")
#display(df_sql)
...
print("Table 2017_K12Education with Dropped Columns")
#df2.show()
