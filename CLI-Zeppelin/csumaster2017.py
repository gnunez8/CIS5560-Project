...
print("Table 2017_CaliforniaStateUniversity")
df.show()
...
# %sql
#select * from `2017_CaliforniaStateUniversity_csv`

#df.take(10)

#df_sql = spark.sql("select * from 2017_CaliforniaStateUniversity_csv LIMIT 10")
#display(df_sql)
...
print("Table 2017_CaliforniaStateUniversity with Dropped Columns")
#df2.show()
