...
print("Table 2015_CommunityCollegeDistrict")
df.show()
...
# %sql
#select * from `2015_CommunityCollegeDistrict_csv`

#df.take(10)

#df_sql = spark.sql("select * from 2015_CommunityCollegeDistrict_csv LIMIT 10")
#display(df_sql)
...
print("Table 2015_CommunityCollegeDistrict with Dropped Columns")
#df2.show()
