...
print("Table 2020_CaliforniaStateUniversity")
df.show()
...
# %sql
#select * from `2020_CaliforniaStateUniversity_csv`

#df.take(10)

#df_sql = spark.sql("select * from 2020_CaliforniaStateUniversity_csv LIMIT 10")
#display(df_sql)
...
print("Table 2020_CaliforniaStateUniversity with Dropped Columns")
#df2.show()
