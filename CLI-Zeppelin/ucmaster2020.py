...
file_location = "/user/jdang8/2020_UniversityOfCalifornia.csv"
file_type = "csv"
...
print("Table 2020_UniversityOfCalifornia")
df.show()
...
# %sql
#select * from `2020_UniversityOfCalifornia_csv`

#df.take(10)

#df_sql = spark.sql("select * from 2020_UniversityOfCalifornia_csv LIMIT 10")
#display(df_sql)
...
print("Table 2020_UniversityOfCalifornia with Dropped Columns")
#df2.show()
