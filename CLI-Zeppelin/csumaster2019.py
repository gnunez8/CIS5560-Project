...
print("Table 2019_CaliforniaStateUniversity")
df.show()
...
# %sql
#select * from `2019_CaliforniaStateUniversity_csv`

#df.take(10)

#df_sql = spark.sql("select * from 2019_CaliforniaStateUniversity_csv LIMIT 10")
#display(df_sql)
...
print("Table 2019_CaliforniaStateUniversity with Dropped Columns")
#df2.show()
