...
file_location = "/user/jdang8/2015_UniversityOfCalifornia.csv"
file_type = "csv"
...
print("Table 2015_UniversityOfCalifornia")
df.show()
...
# %sql
#select * from `2015_UniversityOfCalifornia_csv`

#df.take(10)

#df_sql = spark.sql("select * from 2015_UniversityOfCalifornia_csv LIMIT 10")
#display(df_sql)
...
print("Table 2015_UniversityOfCalifornia with Dropped Columns")
#df2.show()
