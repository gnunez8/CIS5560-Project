...
print("Table 2018_CommunityCollegeDistrict")
df.show()
...
# %sql
#select * from `2018_CommunityCollegeDistrict_csv`

#df.take(10)

#df_sql = spark.sql("select * from 2018_CommunityCollegeDistrict_csv LIMIT 10")
#display(df_sql)
...
print("Table 2018_CommunityCollegeDistrict with Dropped Columns")
#df2.show()
